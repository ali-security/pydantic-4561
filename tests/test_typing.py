...
@pytest.mark.skipif(
    ...
    reason="PEP585 generics only supported for python 3.9 and above.",
)
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            'dict["Hero", list["Team"]]',
            'dict[ForwardRef("Hero"), list[ForwardRef("Team")]]',
        ),
        (
            'dict["Hero", List["Team"]]',
            'dict[ForwardRef("Hero"), List[ForwardRef("Team")]]',
...
@pytest.mark.skipif(
    sys.version_info < (3, 10), reason="NewType class was added in python 3.10."
)
...
@pytest.mark.skipif(
    ...
    reason="PEP604 unions only supported for python 3.10 and above.",
)
